            ...
            <div class="main-content">
                ...
                ?>
                    <div class="list-main-content">
                        <a href="<?=get_permalink( $post->ID )?>" class="anim-loader-skeleton">
                            <?php
                        ...
                        <div class="wrap-media-content">
                            <div class="wrap-ctn-header anim-loader-skeleton">
                                <a href="<?=get_permalink( $post->ID )?>" class="ctn-header"><?=$post->post_title;?></a>
                            </div>    
                            <div class="wrap-ctn-info anim-loader-skeleton">
                                <p class="ft ctn-info"><a href="<?=get_author_posts_url( $post->post_author )?>" class="ft ctn-info-cat"><?=get_the_author_meta( 'user_firstname', $post->post_author );?>&nbsp;<?=get_the_author_meta( 'user_lastname', $post->post_author );?></a> / <?=substr( $post->post_date, 0, 16 );?> / <a href="<?=get_category_link( get_the_category( $post->ID )[0]->term_id );?>" class="ft ctn-info-cat">#<?=get_the_category( $post->ID )[0]->name;?></a></p>
                            </div>
                            <div class="wrap-ctn-content anim-loader-skeleton">    
                                <p class="ft ctn-content"><?=$post->post_content?></p>
                            </div>                                
                        </div>
                    </div>
                <?php 
