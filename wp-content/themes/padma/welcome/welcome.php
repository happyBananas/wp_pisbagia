...
if (!class_exists('PADMA_WELCOME')) :
    ...
    class PADMA_WELCOME {
        ...
        public function admin_notice() {
            $hide_notice = get_option('padma_hide_notice2');
            if (!$hide_notice) {
                ...
                <div class="padma-welcome-notice-wrap">
                    ...
                    <div class="padma-welcome-info">
                        <div class="padma-welcome-import">
                            <p><a class="button button-primary" target="_blank" href="<?php echo esc_url( __( 'https://ashathemes.com/padma/', 'padma' ) ); ?>"><?php esc_html_e( 'View Demo', 'padma' ); ?></a></p>
                        </div>
                    ...
                    <a href="<?php echo wp_nonce_url(add_query_arg('padma_hide_notice2', 1), 'padma_hide_notice2_nonce', 'padma_notice_panel'); ?>" class="notice-close"><?php esc_html_e('Dismiss', 'padma'); ?></a>
                </div>
        ...
        public function hide_admin_notice() {
            if (isset($_GET['padma_hide_notice2']) && isset($_GET['padma_notice_panel']) && current_user_can('manage_options')) {
                if (!wp_verify_nonce(wp_unslash($_GET['padma_notice_panel']), 'padma_hide_notice2_nonce')) {
                    wp_die(esc_html__('Action Failed. Something is Wrong.', 'padma'));
                }

                update_option('padma_hide_notice2', true);
            }
        }
        ...
        public function erase_hide_notice() {
            delete_option('padma_hide_notice2');
        }
    }
